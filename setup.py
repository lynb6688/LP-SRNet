...
if __name__ == '__main__':
    ...
    setup(
        name='lp-srnet',
        version=get_version(),
        description='LP-SRNet: Line-Structured-Light Pavement Super-Resolution Network',
        long_description=readme(),
        long_description_content_type='text/markdown',
        author='Yi Liang',
        author_email='230260401@seu.edu.cn',
        keywords='LP-SRNet, pavement distress, longitudinal super-resolution, depth image',
